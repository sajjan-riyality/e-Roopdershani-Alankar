...
<head>
    ...
    <title>Roopdershani Alankar </title>
...
<section id="new-products-area" class="p-5">
    <div class="ruby-container">
        <div class="row">
...
<div id="category-feature-product" class="pt-3">
    <div class="ruby-container">
        <div class="row">
            <div class="col-lg-6">
                <div class="row">
                        ...
                        <div class="single-product-item text-center">
                            ...
                            <div class="product-details">
                                ...
                                <span class="product-bedge">New</span>
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-placement="left" title="Quick View">view</span>
                                            </button>
                        ...
                        <div class="col-sm-6">
                            <div class="single-cat-item">
                                <figure class="category-thumb">
                                    <a href="#"><img src="assets/img/women-cat.jpg" alt="Women Category" class="img-fluid"></a>
                ...
                <div class="small-size-cate">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="single-cat-item">
                                <figure class="category-thumb">
                                    <a href="#"><img src="assets/img/product-2.jpg" alt="Men Category" class="img-fluid"></a>
                        ...
                        <div class="col-sm-6">
                            <div class="single-cat-item">
                                <figure class="category-thumb">
                                    <a href="#"><img src="assets/img/suit-cat.jpg" alt="Men Category" class="img-fluid"></a>
        ...
        <div class="row">
            <div class="col-lg-8 m-auto">
                <div class="newsletter-form-wrap">
                    <form id="subscribe-form" action="https://htmlmail.hasthemes.com/raju/ruby-subscribe.php"
                          method="post">

...
<head>
    ...
    <title>Single Product :: Roopdershani alankar</title>
                        ...
                        <div class="col-lg-7 mt-5 mt-lg-0">
                            <div class="product-details">
                                ...
                                <div class="product-btn-group">
                                    <a href="wishlist.php" class="btn btn-add-to-cart btn-whislist">+ Add to
                                        Wishlist</a>
                                    <a href="compare.php" class="btn btn-add-to-cart btn-whislist">+ Add to
                                        Compare</a>
                                </div>
                            </div>
                        </div>

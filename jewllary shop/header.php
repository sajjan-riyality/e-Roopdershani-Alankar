...
<header id="header-area" class="header__3">
        ...
        <div class="row">
            ...
            <div class="col-3 col-lg-1 col-xl-2 m-auto" >
                <a href="index.php" class="logo-area">
                    <img src="assets\img\alankar-2.jpg" alt="Logo"  class="img-fluid"/>
                </a>
            </div>
            <!-- Logo Area End -->
                        ...
                        <ul>
                           ...
                           <!--  <li class="dropdown-show"><a href="#">Shop</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    <li class="mega-menu-item"><a href="shop-right-sidebar.php" class="mega-item-title">Shop
                                        Layout</a>
                                        <ul>
                                            <li><a href="shop-right-sidebar.php">Shop products</a></li>
                                    ...
                                    <li class="mega-menu-item"><a href="#" class="mega-item-title">Others Pages</a>
                                        <ul>
 ...
 -->
                            ...
                            <li class="dropdown-show"><a href="products.php">products</a>
                                <ul class="mega-menu-wrap dropdown-nav">
                                    <li class="mega-menu-item"><a href="products.php"
                                                                  class="mega-item-title">javellary</a>
                                        

                                        <ul>
                                            <li><a href="productGallary.php">traditional nekless</a></li>
                                            <li><a href="productGallary.php ">western nekless</a></li>
                                            <li><a href="productGallary.php ">traditional mangalsutra</a></li>
                                            <li><a href="productGallary.php ">vestern mangalsutra</a></li>
                                            <li><a href="productGallary.php ">moti set </a></li>
                                        </ul>
                                    </li>

                                    <li class="mega-menu-item"><a href="shop-left-full-wide.html"
                                                                  class="mega-item-title">accesseries</a>
                                        <ul>
                                            <li><a href="productGallary.php ">haldi set</a></li>
                                            <li><a href="productGallary.php ">hear acceseries</a></li>
                                            <li><a href="productGallary.php ">watch</a></li>
                                            <li><a href="productGallary.php ">hand cluch </a></li>
                                            <!-- <li><a href="shop.html"></a></li> -->
                                        </ul>
                                    </li>

                                    <li class="mega-menu-item"><a href="shop-left-full-wide.html"
                                                                  class="mega-item-title">cosmaticts</a>
                                      <!--   <ul>
